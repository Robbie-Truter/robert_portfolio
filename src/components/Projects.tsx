...
const projects = [
  ...
  },
  {
    ...
    icon: <Map className="text-lofi-wood" size={24} />,
    github: "https://github.com/Robbie-Truter",
  ...
  },
  {
    ...
    icon: <Plane className="text-lofi-matcha" size={24} />,
    github: "https://github.com/Robbie-Truter",
    tags: ["Vue", "Node.js"],
  },
  {
    ...
    icon: <Gamepad2 className="text-lofi-wood" size={24} />,
    github: "https://github.com/Robbie-Truter",
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group bg-white/60 backdrop-blur-sm border border-lofi-accent p-8 rounded-2xl hover:shadow-lg hover:border-lofi-wood/50 transition-all duration-300"
            >
              <div className="flex justify-between items-start mb-6">
                <div className="p-3 bg-lofi-bg rounded-xl border border-lofi-accent/50">
                  {project.icon}
                </div>
                <div className="flex gap-3">
                  <a
                    ...
                    className="text-lofi-text/50 hover:text-lofi-text transition-colors"
                  >
                    <GithubIcon size={20} />
                  </a>
                  <a
              ...
              <div className="mb-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {project.status === "In Development" && (
                    <span className="text-[10px] uppercase tracking-wider font-semibold px-2 py-1 bg-lofi-matcha/10 text-lofi-matcha rounded-full">
                      WIP
                    </span>
                  )}
                </div>
                <p className="text-lofi-text/70 font-light text-sm leading-relaxed">
                  {project.desc}
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-auto">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-xs font-medium text-lofi-wood bg-lofi-bg px-2 py-1 rounded"
                  >
                    {tag}
                  </span>
                ))}
